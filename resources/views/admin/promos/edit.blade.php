                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="discount_type" id="discountType" required
                                ...
                                <option value="percent"
                                    {{ old('discount_type', $promo->discount_type) === 'percent' ? 'selected' : '' }}>
                                    Persentase (%)</option>
                                <option value="fixed"
                        ...
                        <div>
                            ...
                            <input type="number" name="discount" id="discountInput"
                                value="{{ old('discount', $promo->discount) }}" min="0" required
                                class="w-full px-4 py-2.5 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg text-sm focus:ring-2 focus:ring-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="status"
                                ...
                                <option value="nonaktif"
                                    {{ old('status', $promo->status) == 'nonaktif' ? 'selected' : '' }}>Nonaktif
                                </option>
                            </select>
                        </div>
