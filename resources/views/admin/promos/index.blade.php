            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="bg-gray-50 dark:bg-gray-700/50">
                                ...
                                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Promo</th>
                                <th class="text-left px-5 py-3 text-xs font-semibold text-gray-500 uppercase tracking-wider">Diskon</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="px-2.5 py-1 bg-indigo-50 text-indigo-600 text-xs font-bold rounded-lg">
                                        {{ $promo->discount }}%
                                    </span>
                                </td>
                                <td class="px-5 py-3.5">
                                    <span class="inline-block px-2.5 py-1 rounded-full text-xs font-semibold
                                        {{ $promo->status == 'aktif' ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700' }}">
                ...
                @else
                    <div class="text-center py-16 text-gray-400 text-sm">
                        Belum ada promo.
                        <a href="{{ route('admin.promos.create') }}" class="text-indigo-500 hover:underline">
                            Tambah sekarang
                        </a>
                    </div>
                @endif
