            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div class="p-6">
                            ...
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
                                ...
                                <ol class="text-sm text-blue-800 dark:text-blue-300 space-y-1 list-decimal list-inside">
                                    ...
                                    <li>{{ __('Tekan tombol "Check-out" untuk konfirmasi') }}</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('Check-in') }}</p>
                                    <p class="text-sm font-semibold text-green-600">{{ $attendance->getCheckInTimeFormatted() }}</p>
                                </div>
                                <div>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 uppercase tracking-wide">{{ __('Waktu Sekarang') }}</p>
                    ...
                    <div class="space-y-3">
                        ...
                        <form id="checkOutForm" action="{{ route('admin.attendance.check-out', $therapist->id) }}" method="POST" style="display: none;">
                            @csrf
